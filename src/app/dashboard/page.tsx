...
export default function Dashboard() {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            // Fetch Purchases (Mocked product join if foreign keys are tricky with loose schema, but let's try standard)
            // Assuming 'purchases' has product_id and linked to 'products'
